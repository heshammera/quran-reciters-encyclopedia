...
export const SURAHS: SurahMetadata[] = [
    ...
    { number: 3, name: "آل عمران", englishName: "Al-Imran", ayahCount: 200 },
    ...
    { number: 48, name: "الفتح", englishName: "Al-Fat-h", ayahCount: 29 },
    ...
    { number: 58, name: "المجادلة", englishName: "Al-Mujadilah", ayahCount: 22 },
