...
export default function WelcomePopup() {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm animate-in fade-in duration-500">
            {/* Main Modal */}
            <div className="relative bg-white dark:bg-slate-900 rounded-[2rem] shadow-2xl border border-white/20 dark:border-slate-800 max-w-lg w-full overflow-hidden animate-in zoom-in-95 duration-300">
                <div className="p-8 text-center space-y-6">
                    {/* Logo/Icon */}
                    <div className="mx-auto w-20 h-20 bg-emerald-50 dark:bg-emerald-900/20 rounded-2xl flex items-center justify-center text-4xl shadow-inner">
                        ✨
                    </div>

                    <div className="space-y-2">
                        <h2 className="text-3xl font-bold text-slate-900 dark:text-white" style={{ fontFamily: "'Aref Ruqaa', serif" }}>
            ...
            {/* Arrows Layout Layer - Fixed to screen bounds */}
